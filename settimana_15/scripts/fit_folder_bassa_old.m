...
for i = 1:numel(runs)
    ...
    if type == 'a'
        tmp = f(params(1), params(2) / 2, V);
    end
    if type == 'b'
        tmp = f(params(1), params(2) / 2, params(3), V);
    end
    if type == 'c'
        tmp = f(params(1), params(2) / 2, params(3), params(4), V);
    end
    if type == 'd'
        tmp = f(params(1), params(2) / 2, params(3), params(4), params(5), V);
    end
