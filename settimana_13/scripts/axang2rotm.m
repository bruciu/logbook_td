...
% ho preso questo file da qui https://github.com/robotology-legacy/mex-wholebodymodel/blob/master/mex-wholebodymodel/matlab/utilities/%2BWBM/%2Butilities/axang2rotm.m
    if (size(axang,1) ~= 4)
        error("errore da labellare");
